---
title: "Dunnhumby Case"
author: "Jacqueline Berracasa"
date: "3/26/2019"
...
df_syrup
```
Pancake: Aunt Jemima (top 3)
Pasta: Private Label (no variety)
Pasta Sauce: Ragu and Prego (mostly Ragu)
Pancake Syrup: Aunt Jemima, private label, Mrs Butterworth (more variety)
...
top5_syrupb
```
All commodities have much more variety by brand than by product. 


Additional things to explore: does this grocery store have a generic/store brand? Why isn't that brand doing as well? I would think that it would be in the grocery store's best interests to sell a lot of their own brand.
...
```
Propular stores tend to be in the south and midwest parts of the US. 
...
Pasta: 0.8308726  
Syrup: 0.3637111  
Pancake mix: 0.2915684  
Pasta Sauce: 0.7682698   
...
High repeat rate for pasta and pasta sauce so that's good, but this could also just mean that pasta and pasta sauce are bought more frequently than syrup and pancake mix. 
I would want to compare the repeat rate for other "staple" type items that people eat frequently like bread, eggs, etc. This would be a good time to get advice from industry experts in the field to see which items would be good comparison
...
From the plot above, it looks like there are trends in sales.
There are low sales around week 0 and week 45 and high sales around week 25 and week 75.
Sales don't appear to be decreasing over the given period of time so that shows good health of the category.

## Question F  

I wanted to join causal with transactions and run a linear regression on dollar_sales (only for pasta)
with feature_desc, display_desc, store #, and brand to see if any of these things are good predictors of sales
but data was too large for my computer. Therefore, I looked at some graphs and aggregate summary statistics to see if there was anything else interesting that I could find in the data.
...
It is interesting to note that store 270 is the only store that is top 5 in number of displays and also in sales. It would be interesting to look at sales when no display and then look at sales when there is a display and see if there is a statistical difference in sales. Would be interesting to determine if we are spending money on displays when we don't need to be. 
